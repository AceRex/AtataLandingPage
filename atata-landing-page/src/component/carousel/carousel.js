    ...
    <div className="container bg-carousel">
      <div className="animation-container">
        <TextLoop interval="5000">
          ...
          <span className="text">Sculpture at your Click</span>
          <span>
            <img src={Img3} className="zebra-img" />
          </span>
          <span className="text">One Big Africa Art Market</span>
          <span>
            <img src={Img5} className="Art-img" />
          </span>
        </TextLoop>{" "}
        <TextLoop interval="5000">
          <span className="text text-mobile">
            <p>African Artworks </p>and Handicrafts Home
          </span>
          <span>
            <img src={Img2} className="sculp-img" />
          </span>
          <span className="text">Animal Skin at ease</span>
          <span>
            <img src={Img4} className="map-img" />
          </span>
          <span className="text"><p>Buy and Bid for</p>African Painting</span>
        </TextLoop>{" "}
      </div>
